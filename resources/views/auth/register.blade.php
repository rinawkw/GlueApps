            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="content ot-article">
                        ...
                        <!--== Post Reply ==-->
                            <h4 class="main-heading"><span>Silakan Register Akun</span></h4>
                            <div class="comment-form-body">
                                <div class="row">
                                    <form class="comment-form" role="form" method="POST" action='do_register'>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="namalengkap" type="text" placeholder="nama lengkap" name="namalengkap" required autofocus>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="nomortelepon" type="text" placeholder="nomor telepon" name="nomortelepon" required autofocus>
                                        </div>
                                        <div class="col-md-3"></div>
                                        <div class="col-md-6">
                                            <label for="nimnrp">NIM / NRP</label>
                                            <input id="nimnrp" type="text" placeholder="nim / nrp" name="nimnrp" required autofocus>
                                        </div>
                                        <div class="col-md-3"></div>
                                        <div class="col-md-12">
                                            ...
                                            @endif
                                            <p class="form-submit">
                                                <input name="submit" type="submit" id="submit" class="submit submit-button" value="Register" />
                                ...
                                <p class="wp-caption-text">Sudah punya Akun? <a href="{{'login'}}"><b>Login</b></a> </p>
                            </div>
                        </div>
                    </div>
                </div>
