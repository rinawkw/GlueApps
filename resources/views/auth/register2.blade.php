...
<div style="max-width: 500px; align-self: center; position:relative; margin: 5% auto"
    ...
    <div style="padding: 2em 2em 1em 2em; width: 500px !important" class="loginbox" align="center">
        <img src="/images/BANK_INDONESIA.png" height="30%" width="30%" visibility="hidden" align="left" hspace="10"
             vspace="10">
        <br><br>
        <img src="/images/GLUETELA.png" height="50%" width="50%" visibility="hidden">
        <br><br>
        ...
        <form class="comment-form" role="form" method="POST" action='do_register'>
            ...
            <div class="loginbox-textbox">
                <input style="height: 2.5em;" id="namalengkap" type="text" placeholder="nama lengkap"
                       name="namalengkap" required autofocus class="form-control"/>
            </div>
            <div class="loginbox-textbox">
                <input style="height: 2.5em;" id="email" type="email" placeholder="email" name="email" required
    ...
    <div style="text-align: center; padding-top: 3px; color: blue; background-color: #eee;">Something wrong? contact <b>mirnayanti@bi.go.id</b>
    </div>
</div>
<!--Basic Scripts-->
